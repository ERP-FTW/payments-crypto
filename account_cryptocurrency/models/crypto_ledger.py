...
class CryptoProviderEvent(models.Model):
    ...
    provider_id = fields.Many2one("crypto.transfer.provider", required=True, check_company=True, ondelete="restrict")
    ...
    signature = fields.Char(readonly=True, groups="account_cryptocurrency.group_crypto_transfer_admin")
    ...
    transfer_id = fields.Many2one("crypto.transfer", readonly=True, check_company=True)
...
class CryptoSettlement(models.Model):
    ...
    source_transfer_id = fields.Many2one("crypto.transfer", check_company=True, ondelete="restrict")
